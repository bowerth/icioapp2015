...
## visualize_internal.input <- column(width = 3,
##                           box(
##                             width = NULL,
##                             ## title = "Controls",
...
visualize_internal.output <- column(width = 12,
                          ...
                          ## ,
                           box(width = NULL, collapsible = TRUE, collapsed = FALSE,
                               dimpleOutput("dimple", height = "650px"),
                               downloadButton("download_dimple", "Download HTML")
                               )

                           ,
                           box(width = NULL, collapsible = TRUE, collapsed = FALSE,
                               d3heatmapOutput("heatmap", height = "650px")
                               )
                           ,
                           box(width = NULL, collapsible = TRUE, collapsed = FALSE,
                               scatterplotThreeOutput("scatterplot", height = "650px")
                               )
